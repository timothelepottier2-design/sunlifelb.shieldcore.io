CreateThread(function()
    ...
    -- Desactive: laisse cfx-gabz-pdm gerer le Premium Deluxe Motorsport (interieur 7170)
    Simeon.LoadDefault()
    ...
    if GetGameBuildNumber() >= 2699 then
        -- Desactive: conflit avec cfx-gabz-pdm (interieur 7170, Premium Deluxe Motorsport)
    ...
    if GetGameBuildNumber() >= 2944 then
        ...
        -- Desactive: m23_1_legacy_fixes remet les collisions d'origine (barriere invisible) autour de cfx-gabz-pdm sur build >= 2944
