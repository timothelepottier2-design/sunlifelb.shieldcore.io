...
Config.SoundFile        = true         -- Sound file stored in ui/audio used for notification sound. Leave as false to disable.
...
Config.Pictures = {
    ...
    CHAR_GALAXY                      = "char_galaxy.jpg",
    CHAR_SNOWMEN                     = "char_snowmen.png",
    CHAR_BURGERSHOT                  = "char_burgershot.png",
    CHAR_FISHING                     = "Char_fishing.png",
    CHAR_DYNASTY8                    = "char_dynasty8.png",
    CHAR_HAYES                       = "char_hayes.png",
    CHAR_DISCORD                     = "char_discord.jpg",
    CHAR_DOJ                         = "char_doj.jpg",
    CHAR_SUNLIFE                     = "char_sunlife.png",
    CHAR_IZAKAYA                     = "char_izakaya.png",
    CHAR_LSLBAR                      = "char_lslbar.png",
    CHAR_YELLOWJACK                  = "char_yellowjack.png",
    CHAR_UNICORN                     = "CHAR_UNICORN.png",
    CHAR_PIZZERIA                    = "char_pizzeria.png",
    CHAR_STUDIO                      = "char_studio.jpg",
    CHAR_URBAN                       = "CHAR_URBAN.jpg",
    CHAR_REX                         = "CHAR_REX.png",
    CHAR_PALETOAUTO                  = "CHAR_PALETOAUTO.png",
    CHAR_HARMONY                     = "CHAR_HARMONY.png",
    CHAR_GROTTI                      = "char_grotti.png",
    CHAR_LTD                         = "CHAR_LTD.png",
    CHAR_BNS                         = "CHAR_BNS.png",
    CHAR_UWU                         = "CHAR_UWU.png",
    CHAR_KEBAB                       = "CHAR_KEBAB.png",
    CHAR_BEACHCLUB                   = "CHAR_BEACHCLUB.png",
    CHAR_STREETTUNERS                = "CHAR_STREETTUNERS.png",
    CHAR_BOBCAT                      = "char_bobcat.png",
    CHAR_BLACKWOODS                  = "char_blackwoods.png",
}