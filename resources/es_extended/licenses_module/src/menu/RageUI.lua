            ...
            if RageUI.CurrentMenu ~= nil then
                if RageUI.CurrentMenu() then
                    ...
                    if Glare then
                        ...
                        if RageUI.CurrentMenu.SafeZoneSize then
                            ---@type number
                            ...
                            local GlareX = RageUI.CurrentMenu.X / 1860 + RageUI.CurrentMenu.SafeZoneSize.X / 58.100
                            ---@type number
                        ...
                        if Glarewidth and Glareheight then
...
function RageUI.Description()
    ...
    if CurrentMenu ~= nil and CurrentMenu.Description ~= nil then
        ...
        Graphics.Text(CurrentMenu.Description, CurrentMenu.X + Description.Text.X, CurrentMenu.Y + Description.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, Description.Text.Scale * 0.85, 255, 255, 255, 255, nil, false, false, Description.Background.Width + CurrentMenu.WidthOffset - 8.0)
        ...
        if RageUI.CurrentMenu() then
            ...
            if RageUI.CurrentMenu.Controls.Back.Enabled and RageUI.CurrentMenu.Closable then
                if RageUI.CurrentMenu.Controls.Back.Pressed then
                    ...
                    if RageUI.CurrentMenu ~= nil and RageUI.CurrentMenu.Parent ~= nil then
...
function RageUI.ItemsFakeDescription(CurrentMenu, Description, Selected)
    ---@type table
    if Description ~= "" or Description ~= nil then
        local SettingsDescription = RageUI.Settings.Items.Description;
        if Selected and CurrentMenu.Description ~= Description then
...
function RageUI.RefreshPagination()
    if (RageUI.CurrentMenu ~= nil) then
        if (RageUI.CurrentMenu.Index > 12) then
            local offset = RageUI.CurrentMenu.Index - 12
            RageUI.CurrentMenu.Pagination.Minimum = 1 + offset
            RageUI.CurrentMenu.Pagination.Maximum = 12 + offset
        else
            RageUI.CurrentMenu.Pagination.Minimum = 1
            RageUI.CurrentMenu.Pagination.Maximum = 12
        end
