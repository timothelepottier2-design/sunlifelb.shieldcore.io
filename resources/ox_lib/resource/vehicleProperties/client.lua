...
AddStateBagChangeHandler('ox_lib:setVehicleProperties', '', function(bagName, _, value)
    ...
    if NetworkGetEntityOwner(entity) == cache.playerId then
        lib.setVehicleProperties(entity, value)
        -- print(('^3[NETDIAG][STATEBAG]^7 %s vehicleProperties/client.lua:122 Entity(%s).state:set ox_lib:setVehicleProperties=nil (replicated)'):format(GetCurrentResourceName(), tostring(entity)))
