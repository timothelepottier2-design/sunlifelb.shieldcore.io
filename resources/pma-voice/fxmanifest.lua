...
convar_category 'PMA-Voice' {
	...
	{ "Voice phone volume", "$voice_defaultPhoneVolume", "CV_INT", "70" },
	...
	{ "Max proximity range (anticheat)", "$voice_maxProximityRange", "CV_INT", "25" },
	{ "Kick on proximity hack", "$voice_kickOnProximityHack", "CV_INT", "0" },
    }
}
