Config = {
	...
	Text = {
		...
		REGISTER_LANE = '~INPUT_PICKUP~ Créer une nouvelle partie~n~~INPUT_SPRINT~ + ~INPUT_PICKUP~ Créer une nouvelle partie en équipe',
		JOIN_LANE = '~INPUT_PICKUP~ Rejoindre la partie',
		PLAY = '~INPUT_PICKUP~ Jouer',
		OPEN = '~INPUT_PICKUP~ Ouvrir',
		TAKE_BALL = '~INPUT_PICKUP~ Récupérer la boule',

		NOT_IN_GAME = 'Vous ne jouez pas au bowling en ce moment.',
		NOT_ENOUGH_MONEY = "Vous n'avez pas assez d'argent !",
		INPUT_POSITION = 'Sélectionnez la ~y~position de la boule',
		INPUT_ROTATION = 'Sélectionnez la ~y~rotation de la boule',
		INPUT_ANGLE = "Sélectionnez ~y~l'angle de tir",
		INPUT_POWER = "Ajustez la ~y~force de frappe",
		
        TOTAL = "Total",
        MATCH_END = "Fin de la partie dans {0} secondes",
		MATCH_WHO_WON = "{0} gagné ${1}",
