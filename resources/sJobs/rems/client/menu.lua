...
local mainMenu = NativeUI.CreateMenu('', 'Sélectionnez votre tenue', 1, 100, "mrv_cameracreator", "mrv_cameracreator")

for name, list in pairs(categoryOutfits) do
    local subMenu = menuPool:AddSubMenu(mainMenu, name, nil, 100, "mrv_cameracreator", "mrv_cameracreator")
